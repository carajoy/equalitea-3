...
- `assets/production/headshots/Gabrielle_Benson_User_Provided.jpg` — final approved headshot
- `assets/production/headshots/Adrienne_Percival_User_Provided.jpg` — final approved headshot

### Superseded placeholder assets — do not use
- `assets/headshots/PLACEHOLDER_Gabrielle_Benson_PA-C.png`
- `assets/headshots/PLACEHOLDER_Adrienne_Perceval.png`

These placeholder files remain only as historical source artifacts. They are superseded by the final approved user-supplied headshots listed above. The approved spelling is `Adrienne Percival`.

### Responsive production headshots
- `assets/production/headshots/responsive/`
  - Contains 240-pixel-wide compressed JPEG candidates for small program and speaker-card placements.
  - The page retains larger optimized production files for biography layouts and higher-density displays.
  - Do not replace these production variants with oversized originals.
